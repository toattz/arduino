//http://ulasdikme.com/index.php/2016/08/21/arduino-modbus-example/
...
void loop()
{
  ...
  if(RxGo == 1) // transmission will start
  {
    ...
    // Read Digital Inputs - start - Depending on sendData[2] ( number of byte of the sending data) 
      ...
      else if(readCoilGo == 2)
      {
        Serial1.println("readCoilGo == 2");
      }
      else if(readCoilGo == 3)
      {
        Serial1.println("readCoilGo == 3");
      }
      else
      {
        Serial1.println("readCoilgo == else");
      }
      /*----------------------------- End Of ReadCoil --------------------------------------------- */
